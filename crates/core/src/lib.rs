...
pub use catalog::{
    ...
    ForeignKeyReferenceMetadata, Index, IndexMetadata, LiteralKind, ObjectType, RelationField,
    Schema, SchemaId, SchemaKey, SchemaMetadata, Table, TableConstraintKind,
