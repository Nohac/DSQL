...
#[test]
fn clauses_lower_with_expression_trees() {
    block_on(async {
...
#[test]
fn operator_variables_lower_inside_expressions() {
    block_on(async {
        let bowl = language_bowl().await;
...
#[test]
fn directives_lower_into_facts() {
    block_on(async {
        let bowl = language_bowl().await;
...
#[test]
fn variable_occurrences_become_facts() {
    block_on(async {
        let bowl = language_bowl().await;
