...
**ID:** 31ddc5f2 | **Status:** Done | **Created:** 2026-08-05T01:31:36+02:00
...
Policy declarations now resolve and compile on stable per-declaration sites.
Visible compiled filters relate directly to semantic definition roots, while a
single stable registry owner assembles the settled generation snapshot. The
ambient policy body/index views, `DefIndex`, and `ContextIndex` are removed;
sequential insertion, removal, replacement, and source revisits are covered.
